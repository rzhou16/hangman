...
function init() {
	...
	ins.innerHTML = "Instruction: Enter your name. You have " + MAX_ATTEMPTS + " wrong attempts and " + MAX_TIME + "s for each question.";
	...
	but.onclick = function() {localSave(NAME, name.value); window.location.href = "lab3_game.html";};
